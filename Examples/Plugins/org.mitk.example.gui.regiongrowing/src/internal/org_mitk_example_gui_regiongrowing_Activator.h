...
public:
  ...
  static org_mitk_example_gui_regiongrowing_Activator* GetInstance();

  berry::IPreferencesService* GetPreferencesService();
private:

    static org_mitk_example_gui_regiongrowing_Activator* m_Instance;
...
typedef org_mitk_example_gui_regiongrowing_Activator PluginActivator;
