...
namespace mitk {
    org_mitk_example_gui_regiongrowing_Activator* org_mitk_example_gui_regiongrowing_Activator::m_Instance = nullptr;
    ctkPluginContext* org_mitk_example_gui_regiongrowing_Activator::m_Context = nullptr;
    ...
    ctkPluginContext* org_mitk_example_gui_regiongrowing_Activator::GetContext()
    {
        return m_Context;
    }

    org_mitk_example_gui_regiongrowing_Activator *org_mitk_example_gui_regiongrowing_Activator::GetInstance()
    {
        return m_Instance;
    }

    berry::IPreferencesService* org_mitk_example_gui_regiongrowing_Activator::GetPreferencesService()
    {
