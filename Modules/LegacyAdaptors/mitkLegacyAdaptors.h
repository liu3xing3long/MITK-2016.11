...
/** \file mitkLegacyAdaptors.h
  *
  * The LegacyAdaptors module is intended to provide an interface to deprecated types/objects/methods as part of
 * backward compatibility
  * Currently the module offers methods for casting an Image or an ImageDataItem respectively to a mitkIpPicDescriptor
 * object since several Algorigthms
  * in MITK Modules still use the deprecated IpPic format and algorithms.
  *
  * \warning The IpPic-related classes are no more accessible through the Core Module. The dependencies needs to be set
 * directly for the affected module. Furthermore,
  * if you want to cast information between mitk::Image and mitkIpPicDescriptor, also the dependency to the
 * LegacyAdaptors module needs to be set.
  */
...
namespace mitk
{
  /**
   ...
   Meant to support legacy code, which was base on mitkIpPicDescriptor types. Please remind that such code should be
   migrated towards ITK/VTK solutions.
 */
  MITKLEGACYADAPTORS_EXPORT mitkIpPicDescriptor *CastToIpPicDescriptor(mitk::Image::Pointer,
  ...
  /**
    ...
    \warning The returned IpPicDescriptor is only referencing the memory block with the data managed by the given
  ...
  */
  MITKLEGACYADAPTORS_EXPORT DEPRECATED(mitkIpPicDescriptor *CastToIpPicDescriptor(mitk::Image::Pointer,
                                                                                  mitkIpPicDescriptor *picDesc));
  ...
  /**
   ...
   to CastToIpPicDescriptor.
  */
  MITKLEGACYADAPTORS_EXPORT DEPRECATED(
    mitkIpPicDescriptor *CastToIpPicDescriptor(itk::SmartPointer<mitk::ImageDataItem>, mitkIpPicDescriptor *picDesc));
  ...
  */
  ...
  /**
    ...
    The IpPicDescriptor uses own notations for different pixel types. This casting is needed e.g. by the
    CastToIpPicDescriptor method.
  */
  ...
  /**
    ...
    The method needs the mitkIpPicType_t and the bits per element (bpe) information to be able to create the correct
    corresponding PixelType
    \sa PixelType
  */
