...
public:
  static void TestPlanarCrossPlacement(mitk::PlanarCross::Pointer planarCross)
  {
    ...
    MITK_TEST_CONDITION(planarCross->IsHelperToBePainted(0),
    ...
    MITK_TEST_CONDITION(((pp2 == p2) && (pp3 == p3)) || ((pp2 == p3) && (pp3 == p2)), "Correct polyline 2");
  ...
  static void TestPlanarCrossPlacementSingleLine(mitk::PlanarCross::Pointer planarCross)
  {
    ...
    MITK_TEST_CONDITION(planarCross->IsHelperToBePainted(0) == false,
                        "No helper line to be painted in single-line mode");
    ...
    MITK_TEST_CONDITION(planarCross->ResetOnPointSelect() == false,
                        "Single-line PlanarCross should not be reset on point edit");
  }
  ...
  static void TestPlanarCrossPlacementConstrained(mitk::PlanarCross::Pointer planarCross)
  {
    ...
    MITK_TEST_CONDITION((fabs(cp0[0]) < mitk::eps) && (fabs(cp0[1] - 20.0) < mitk::eps),
                        "Point1 placed and constrained correctly");
    ...
    MITK_TEST_CONDITION((fabs(cp1[0] - 80.0) < mitk::eps) && (fabs(cp1[1] - 100.0) < mitk::eps),
                        "Point2 placed and constrained correctly");
    ...
    MITK_TEST_CONDITION((fabs(cp2[0] - 90.0) < mitk::eps) && (fabs(cp2[1] - 90.0) < mitk::eps),
                        "Point3 placed and constrained correctly");
    ...
    MITK_TEST_CONDITION((fabs(cp2[0] - 40.0) < mitk::eps) && (fabs(cp2[1] - 20.0) < mitk::eps),
                        "Point3 moved correctly");
    ...
    MITK_TEST_CONDITION((fabs(cp3[0] - 10.0) < mitk::eps) && (fabs(cp3[1] - 50.0) < mitk::eps),
                        "Point4 placed and constrained correctly");
    ...
    MITK_TEST_CONDITION((fabs(cp3[0] - 20.0) < mitk::eps) && (fabs(cp3[1] - 40.0) < mitk::eps),
                        "Point4 placed and constrained correctly");
  }
  ...
  static void TestPlanarCrossEdit(mitk::PlanarCross::Pointer planarCross)
  {
    ...
    MITK_TEST_CONDITION(planarCross->ResetOnPointSelect(),
                        "Editing control point 0: Double-line PlanarCross should be reset");
    ...
    MITK_TEST_CONDITION((planarCross->GetControlPoint(0).EuclideanDistanceTo(p1) < mitk::eps) &&
    ...
    // Request reset and check if it is done
    MITK_TEST_CONDITION(planarCross->ResetOnPointSelect(),
                        "Editing control point 1: Double-line PlanarCross should be reset");

    // Check number of control points
    MITK_TEST_CONDITION(planarCross->GetNumberOfControlPoints() == 2, "Two control points are left");

    // Check if correct control points have been left
    MITK_TEST_CONDITION((planarCross->GetControlPoint(0).EuclideanDistanceTo(p0) < mitk::eps) &&
    ...
    // Request reset and check if it is done
    MITK_TEST_CONDITION(planarCross->ResetOnPointSelect(),
                        "Editing control point 2: Double-line PlanarCross should be reset");

    // Check number of control points
    MITK_TEST_CONDITION(planarCross->GetNumberOfControlPoints() == 2, "Two control points are left");

    // Check if correct control points have been left
    MITK_TEST_CONDITION((planarCross->GetControlPoint(0).EuclideanDistanceTo(p3) < mitk::eps) &&
    ...
    // Request reset and check if it is done
    MITK_TEST_CONDITION(planarCross->ResetOnPointSelect(),
                        "Editing control point 3: Double-line PlanarCross should be reset");

    // Check number of control points
    MITK_TEST_CONDITION(planarCross->GetNumberOfControlPoints() == 2, "Two control points are left");

    // Check if correct control points have been left
    MITK_TEST_CONDITION((planarCross->GetControlPoint(0).EuclideanDistanceTo(p2) < mitk::eps) &&
                          (planarCross->GetControlPoint(1).EuclideanDistanceTo(p3) < mitk::eps),
                        "Reset to expected control points (p2, p3)");
  }

  static void ResetPlanarCross(
    mitk::PlanarCross::Pointer planarCross, mitk::Point2D p0, mitk::Point2D p1, mitk::Point2D p2, mitk::Point2D p3)
  {
