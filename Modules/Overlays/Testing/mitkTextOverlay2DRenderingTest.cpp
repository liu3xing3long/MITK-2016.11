...
mitk::TextOverlay2D::Pointer createTextOverlay(
  int fontsize, float red, float green, float blue, int posX, int posY, std::string text)
{
...
int mitkTextOverlay2DRenderingTest(int argc, char *argv[])
{
  ...
  if (generateReferenceScreenshot)
  {
    renderingHelper.SaveReferenceScreenShot(
      "/home/christoph/Pictures/RenderingTestData/mitkTextOverlay2DRenderingTest_ball.png");
  }
