...
namespace mitk
{
   ...
   *AbstractOverlayLayouter::PrepareLayout() should be implemented with a routine to set the position of the internal
  ...
  */
  ...
  public:
    ...
    /** By calling this, the previous Layouter of the passed Overlays is called to remove this overlay from its internal
     * list.*/
  ...
  protected:
    ...
    /** If the implementation of the layouter can manage the overlay positions in different ways, each instance has to
  have
