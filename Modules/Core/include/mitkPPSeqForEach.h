...
#define MITK_PP_SEQ_FOR_EACH(macro, data, seq)                                                                         \
  MITK_PP_FOR((macro, data, seq(nil)), MITK_PP_SEQ_FOR_EACH_P, MITK_PP_SEQ_FOR_EACH_O, MITK_PP_SEQ_FOR_EACH_M)
#else
#define MITK_PP_SEQ_FOR_EACH(macro, data, seq) MITK_PP_SEQ_FOR_EACH_D(macro, data, seq)
#define MITK_PP_SEQ_FOR_EACH_D(macro, data, seq)                                                                       \
  MITK_PP_FOR((macro, data, seq(nil)), MITK_PP_SEQ_FOR_EACH_P, MITK_PP_SEQ_FOR_EACH_O, MITK_PP_SEQ_FOR_EACH_M)
#endif
#
...
#else
#define MITK_PP_SEQ_FOR_EACH_O(r, x)                                                                                   \
  MITK_PP_SEQ_FOR_EACH_O_I(MITK_PP_TUPLE_ELEM(3, 0, x), MITK_PP_TUPLE_ELEM(3, 1, x), MITK_PP_TUPLE_ELEM(3, 2, x))
#endif
#
...
#else
#define MITK_PP_SEQ_FOR_EACH_M(r, x)                                                                                   \
  MITK_PP_SEQ_FOR_EACH_M_I(r, MITK_PP_TUPLE_ELEM(3, 0, x), MITK_PP_TUPLE_ELEM(3, 1, x), MITK_PP_TUPLE_ELEM(3, 2, x))
#endif
#
...
#
#if ~MITK_PP_CONFIG_FLAGS() & MITK_PP_CONFIG_EDG()
#define MITK_PP_SEQ_FOR_EACH_R(r, macro, data, seq)                                                                    \
  MITK_PP_FOR_##r((macro, data, seq(nil)), MITK_PP_SEQ_FOR_EACH_P, MITK_PP_SEQ_FOR_EACH_O, MITK_PP_SEQ_FOR_EACH_M)
#else
#define MITK_PP_SEQ_FOR_EACH_R(r, macro, data, seq) MITK_PP_SEQ_FOR_EACH_R_I(r, macro, data, seq)
#define MITK_PP_SEQ_FOR_EACH_R_I(r, macro, data, seq)                                                                  \
  MITK_PP_FOR_##r((macro, data, seq(nil)), MITK_PP_SEQ_FOR_EACH_P, MITK_PP_SEQ_FOR_EACH_O, MITK_PP_SEQ_FOR_EACH_M)
#endif
#
#endif
