...
namespace mitk
{
  ...
  public:
    ...
    */
    ...
    /**
    * \return The name of the Bool Property that specifies whether a DataNode is a Node carrying Persistence
    * PropertyLists
    */
    ...
    * will have the property name set to the PropertyList's id and a BoolProperty equal to
    ...
    */
    ...
    /**
    * Save the current PropertyLists to fileName. If fileName is empty, a special file in the users home directory will
    * be
    * used.
...
#define PERSISTENCE_GET_MODULE_CONTEXT_FUNCTION us::GetModuleContext()
...
#define PERSISTENCE_GET_SERVICE_MACRO                                                                                  \
  ...
  {                                                                                                                    \
    ...
    {                                                                                                                  \
      persistenceService = dynamic_cast<mitk::IPersistenceService *>(                                                  \
        context->GetService<mitk::IPersistenceService>(persistenceServiceRef));                                        \
    }                                                                                                                  \
  }
...
#define PERSISTENCE_MACRO_END_PART(THE_CLASS_NAME, ID_MEMBER_NAME)                                                     \
                                                                                                                       ...
                                                                                                                       \
  std::string GetId() const { return ID_MEMBER_NAME; }                                                                 \
private:                                                                                                               \
  PERSISTENCE_GET_SERVICE_METHOD_MACRO                                                                                 \
  struct MyPropertyListReplacedObserver : public mitk::PropertyListReplacedObserver                                    \
  {                                                                                                                    \
    MyPropertyListReplacedObserver() : m_##THE_CLASS_NAME(0), m_PersistenceService(0) {}                               \
...
#define PERSISTENCE_CREATE4(                                                                                           \
  THE_CLASS_NAME, ID_MEMBER_NAME, PARAM_MEMBER_NAME, PARAM2_MEMBER_NAME, PARAM3_MEMBER_NAME, PARAM4_MEMBER_NAME)       \
  PERSISTENCE_MACRO_START_PART(ID_MEMBER_NAME)                                                                         \
  propList->Set(#PARAM_MEMBER_NAME, PARAM_MEMBER_NAME);                                                                \
  propList->Set(#PARAM2_MEMBER_NAME, PARAM2_MEMBER_NAME);                                                              \
  propList->Set(#PARAM3_MEMBER_NAME, PARAM3_MEMBER_NAME);                                                              \
