...
{
  //---- PropertyObserver -----------------------------------------------------------
  PropertyObserver::PropertyObserver() : m_SelfCall(false) {}
  PropertyObserver::~PropertyObserver() {}
  void PropertyObserver::BeginModifyProperty() { m_SelfCall = true; }
  void PropertyObserver::EndModifyProperty() { m_SelfCall = false; }
  //---- PropertyView ---------------------------------------------------------------
  ...
  {
    if (m_SelfCall)
      return; // does this make any sense?
