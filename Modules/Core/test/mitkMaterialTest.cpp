...
public:
  ...
  void testConstructorRedGreenBlueColorCoefficientSpecularCoefficientSpecularPowerOpacity()
  {
    ...
    MITK_TEST_CONDITION(specularPower == myMP->GetSpecularPower(),
                        "Testing if a SpecularPower object was set correctly")
    MITK_TEST_CONDITION(colorCoefficient == myMP->GetColorCoefficient(),
                        "Testing if a colorCoefficient object was set correctly")
  }
  ...
  void testSetColorCoefficient()
  {
    ...
    MITK_TEST_CONDITION(colorCoefficient == myMP->GetColorCoefficient(),
                        "Testing if a colorcoefficent was set correctly")
  }
  ...
  void testSetSpecularCoefficient()
  {
    ...
    MITK_TEST_CONDITION(specularCoefficient == myMP->GetSpecularCoefficient(),
                        "Testing if a SpecularCoefficient was set correctly")
  }
  ...
  {
    {
      ...
      mitk::Material::Pointer myMP2 =
        mitk::Material::New(rgb2, rgb2, rgb2, colorCoefficient2, specularCoefficient2, specularPower2, opacity2);
      double lineWidth2 = 1;
...
int mitkMaterialTest(int /* argc */, char * /*argv*/ [])
{
