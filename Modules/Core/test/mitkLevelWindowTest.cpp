...
void resetLevelWindow(mitk::LevelWindow &lw)
{
  ...
  if (lw.GetRangeMin() != -10000 || lw.GetRangeMax() != 10000 || lw.GetLevel() != 0 || lw.GetWindow() != 500)
  {
...
int mitkLevelWindowTest(int, char *[])
{
  ...
  if (!((levWin->GetLowerWindowBound() == 0) && (levWin->GetUpperWindowBound() == 2) && (levWin->GetLevel() == 1) &&
        (levWin->GetWindow() == 2)))
  {
    std::cout << "[FAILED]" << std::endl;
    return EXIT_FAILURE;
  ...
  if (!((levWin->GetRangeMin() == levWin->GetDefaultLowerBound()) &&
        (levWin->GetRangeMax() == levWin->GetDefaultUpperBound())))
  {
    std::cout << "[FAILED]" << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (!((levWin->GetLowerWindowBound() == -10000) && (levWin->GetUpperWindowBound() == -9999)))
  {
    std::cout << "[FAILED]: Expected (-10000, -9999): " << levWin->GetLowerWindowBound() << " - "
  ...
  if (!((levWin->GetLowerWindowBound() == 4999.5) && (levWin->GetUpperWindowBound() == 5000.5)))
  {
    std::cout << "[FAILED]: Expected (4999.5, 5000.5): " << levWin->GetLowerWindowBound() << " - "
              << levWin->GetUpperWindowBound() << std::endl;
    return EXIT_FAILURE;
  }
  levWin->ResetDefaultLevelWindow();
  ...
  {
    std::cout << "[FAILED]: Expected (-10000, -9999): " << levWin->GetLowerWindowBound() << " - "
              << levWin->GetUpperWindowBound() << " . " << levWin->GetRangeMin() << std::endl;
    return EXIT_FAILURE;
  }
  levWin->ResetDefaultLevelWindow();
  std::cout << "[PASSED]" << std::endl;
  ...
  if (levelWindow.GetUpperWindowBound() != initialUpperBound || levelWindow.GetLowerWindowBound() != initialLowerBound)
  {
    std::cout << "[FAILED]" << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (levelWindow.GetUpperWindowBound() != 110 || levelWindow.GetLowerWindowBound() != -10)
  {
    std::cout << "[FAILED]" << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (crLevelWindow.GetLevel() != 16352.0 || crLevelWindow.GetWindow() != 16444.0)
  {
    std::cout << "[FAILED]" << std::endl;
    return EXIT_FAILURE;
  }
