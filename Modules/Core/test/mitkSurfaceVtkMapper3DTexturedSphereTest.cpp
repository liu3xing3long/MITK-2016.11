...
/**
 * @brief mitkSurfaceVtkMapper3DTexturedSphereTest This test puts a texture onto a sphere. It is a nice example how to
 * use VTK methods to generate texture coordinates for MITK surfaces.
...
int mitkSurfaceVtkMapper3DTexturedSphereTest(int argc, char *argv[])
{
  ...
  MITK_TEST_CONDITION(renderingHelper.CompareRenderWindowAgainstReference(argc, argv, 50.0) == true,
