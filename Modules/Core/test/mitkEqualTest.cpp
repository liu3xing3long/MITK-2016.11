...
public:
  ...
  void Equal_DifferentMitkVector3D_ReturnFalse()
  {
    ...
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Coparison of 2 different 3D MITK vectors (first element). Result should be false.", mitk::Equal(v1, v2), false);
    mitk::Vector3D v3;
    v3.SetElement(0, 1);
    v3.SetElement(1, 2);
    v3.SetElement(2, 1);
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Coparison of 2 different 3D MITK vectors (second element). Result should be false.", mitk::Equal(v1, v3), false);
    mitk::Vector3D v4;
    v4.SetElement(0, 1);
    v4.SetElement(1, 1);
    v4.SetElement(2, 2);
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Coparison of 2 different 3D MITK vectors (third element). Result should be false.", mitk::Equal(v1, v4), false);
  }
  ...
  void Equal_DifferentMitkVector2D_ReturnFalse()
  {
    ...
    v2.SetElement(1, 1);
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Coparison of 2 different 2D MITK vectors (first element). Result should be false.", mitk::Equal(v1, v2), false);
    mitk::Vector2D v3;
    v3.SetElement(0, 1);
    v3.SetElement(1, 2);
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Coparison of 2 different 2D MITK vectors (second element). Result should be false.", mitk::Equal(v1, v3), false);
  }
  ...
  void Equal_DifferentMitkVnlVector_ReturnFalse()
  {
    ...
    v2[0] = 6;
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Comparison of 2 different MITK VNL vectors. Result should be false.", mitk::Equal(v1, v2), false);
  }
  ...
  void Equal_DifferentVnlVector_ReturnFalse()
  {
    ...
    v2[1] = 8.231;
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Comparison of 2 different VNL vectors (first element). Result should be false.", mitk::Equal(v1, v2), false);
    vnl_vector_fixed<mitk::ScalarType, 2u> v3;
    v3[0] = 8.231;
    v3[1] = 2.14;
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Comparison of 2 different VNL vectors (first element). Result should be false.", mitk::Equal(v1, v3), false);
  }
  ...
  void Equal_DifferentItkVector_ReturnFalse()
  {
    ...
    v2.SetElement(0, 1.4);
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Coparison of 2 different ITK vectors (first element). Result should be false.", mitk::Equal(v1, v2), false);
    itk::Vector<mitk::ScalarType, 3u> v3;
    v3.Fill(5.2);
    v3.SetElement(1, 1.4);
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Coparison of 2 different ITK vectors (second element). Result should be false.", mitk::Equal(v1, v3), false);
    itk::Vector<mitk::ScalarType, 3u> v4;
    v4.Fill(5.2);
    v4.SetElement(2, 1.4);
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Coparison of 2 different ITK vectors (third element). Result should be false.", mitk::Equal(v1, v4), false);
  }
  ...
  void Equal_DifferentItkPoint_ReturnFalse()
  {
    ...
    p2[1] = 2.1;
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Comparison of 2 different points (first element). Result should be false.", mitk::Equal(p1, p2), false);
    itk::Point<mitk::ScalarType, 2> p3;
    p3[0] = 2.1;
    p3[1] = 2.1 + 1.01 * mitk::eps;
    CPPUNIT_ASSERT_EQUAL_MESSAGE(
      "Comparison of 2 different points (second element). Result should be false.", mitk::Equal(p1, p3), false);
  }
};
