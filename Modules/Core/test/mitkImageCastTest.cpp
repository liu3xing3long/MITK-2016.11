...
public:
  void Cast_ToMultipleConstItkImages_Succeeds()
  {
    ...
    ItkImageType::ConstPointer itkImage =
      mitk::ImageToItkImage<ItkImageType::PixelType, ItkImageType::ImageDimension>(mitkConstImage);
  ...
  void Cast_ToMultipleNonConstItkImages_Fails()
  {
    ...
    CPPUNIT_ASSERT_THROW((mitk::ImageToItkImage<ItkImageType::PixelType, ItkImageType::ImageDimension>(mitkImage)),
                         mitk::Exception);
  }
};
