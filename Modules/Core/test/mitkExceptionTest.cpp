...
public:
  ...
  static void TestExceptionConstructor()
  {
    ...
    MITK_TEST_CONDITION_REQUIRED(exceptionThrown,
  ...
  static void TestExceptionMessageStreamThrowing()
  {
    ...
    MITK_TEST_CONDITION_REQUIRED(exceptionThrown && (thrownMessage == std::string("message1 and message2")),
  ...
  static void TestMitkThrowMacro()
  {
    ...
    MITK_TEST_CONDITION_REQUIRED((exceptionThrown && (messageText == "test123")),
                                 "Testing message test of mitkThrow()");
  ...
  // normally exceptions should only be instantiated and thrown by using the exception macros!
  {
    ...
    MITK_TEST_CONDITION_REQUIRED(e.GetNumberOfRethrows() == 0,
    ...
    // case 1.2: GetRethrowData() with negative number
    {
      ...
      MITK_TEST_CONDITION_REQUIRED(((file == "") && (line == 0) && (message == "")),
    ...
    // third: test if this rethrow data was stored properly
    {
      ...
      std::string message = "invalid";
      e.GetRethrowData(0, file, line, message);
      MITK_TEST_CONDITION_REQUIRED(((file == "test2.cpp") && (line == 10) && (message == "Rethrow one")),
...

    {
      ...
      std::string message = "invalid";
      e.GetRethrowData(1, file, line, message);
      MITK_TEST_CONDITION_REQUIRED(((file == "test3.cpp") && (line == 15) && (message == "Rethrow two")),
  ...
  static void TestRethrowMacro()
  {
    ...
    MITK_TEST_CONDITION_REQUIRED(message == "Test original message.Test rethrow message.",
