...
namespace mitk
{
    ...
    TransformFactory<TPixelType, VImageDimension>::GetTransform()
  {
    ...
    {
      typename itk::TranslationTransform<double, VImageDimension>::Pointer transformPointer =
        itk::TranslationTransform<double, VImageDimension>::New();
    ...
    //      {
    //        typename itk::Rigid3DTransform< double >::Pointer transformPointer = itk::Rigid3DTransform< double
    //        >::New();
    //        transformPointer->SetIdentity();
    //        m_TransformParameters->SetTransformCenterX(transformPointer->GetCenter()[0]);
    //        m_TransformParameters->SetTransformCenterY(transformPointer->GetCenter()[1]);
    ...
    else if (transform == TransformParameters::VERSORRIGID3DTRANSFORM)
    {
      if (VImageDimension == 3)
      {
        typename itk::VersorRigid3DTransform<double>::Pointer transformPointer =
        ...
        {
          typedef
            typename itk::CenteredTransformInitializer<VersorRigid3DTransformType, FixedImage3DType, MovingImage3DType>
              TransformInitializerType;
          typename TransformInitializerType::Pointer transformInitializer = TransformInitializerType::New();
    ...
    else if (transform == TransformParameters::SIMILARITY3DTRANSFORM)
    {
      if (VImageDimension == 3)
      {
        typename itk::Similarity3DTransform<double>::Pointer transformPointer =
          itk::Similarity3DTransform<double>::New();
        transformPointer->SetIdentity();
        m_TransformParameters->SetTransformCenterX(transformPointer->GetCenter()[0]);
        m_TransformParameters->SetTransformCenterY(transformPointer->GetCenter()[1]);
        m_TransformParameters->SetTransformCenterZ(transformPointer->GetCenter()[2]);
    ...
    else if (transform == TransformParameters::CENTEREDRIGID2DTRANSFORM)
    {
      if (VImageDimension == 2)
      {
        ...
        if (m_TransformParameters->GetTransformInitializerOn())
        {
          ...
          typedef typename itk::
            CenteredTransformInitializer<CenteredRigid2DTransformType, FixedImage2DType, MovingImage2DType>
              TransformInitializerType;
          typename TransformInitializerType::Pointer transformInitializer = TransformInitializerType::New();
    ...
    else if (transform == TransformParameters::SIMILARITY2DTRANSFORM)
    {
      if (VImageDimension == 2)
      {
        typename itk::Similarity2DTransform<double>::Pointer transformPointer =
