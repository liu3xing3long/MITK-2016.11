...
namespace mitk
{
  ...
  void TransformParameters::SetScales(itk::Array<double> scales) { m_Scales = scales; }
  itk::Array<double> TransformParameters::GetScales() { return m_Scales; }
  void TransformParameters::SetInitialParameters(itk::Array<double> initialParameters)
  {
    m_InitialParameters = initialParameters;
  }

  itk::Array<double> TransformParameters::GetInitialParameters() { return m_InitialParameters; }
} // namespace mitk
