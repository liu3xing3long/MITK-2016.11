...
namespace mitk
{
  ...
  void HistogramMatching::SetNumberOfMatchPoints(int matchPoints) { m_NumberOfMatchPoints = matchPoints; }
  void HistogramMatching::SetThresholdAtMeanIntensity(bool on) { m_ThresholdAtMeanIntensity = on; }
  ...
  void HistogramMatching::GenerateData2(const itk::Image<TPixel, VImageDimension> *itkImage1)
  {
    ...
    typedef typename itk::HistogramMatchingImageFilter<InternalImageType, InternalImageType> MatchingFilterType;
