...
ctkPluginContext* org_mitk_gui_qt_matchpoint_visualizer_Activator::m_Context = 0;
...
void org_mitk_gui_qt_matchpoint_visualizer_Activator::stop(
    ctkPluginContext* context)
{
    Q_UNUSED(context)
...
ctkPluginContext* org_mitk_gui_qt_matchpoint_visualizer_Activator::GetContext()
{
    return m_Context;
}
