/*
 * This code is taken from the Graphics Gems book series by Academic Press.
 *
 * For information on the books and more of the source code
 * you can visit http://tog.acm.org/GraphicsGems/
 *
