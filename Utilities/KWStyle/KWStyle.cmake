option(MITK_USE_KWSTYLE "Enable the use of KWStyle for checking coding style." OFF)
if(MITK_USE_KWSTYLE)
...
set(KWSTYLE_CONFIGURATION_FILE 
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/MITK.kws.xml)

set(KWSTYLE_MITK_FILES_LIST
  ${PROJECT_BINARY_DIR}/Utilities/KWStyle/MITKFiles.txt)

set(KWSTYLE_MITK_OVERWRITE_FILE
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/MITKOverwrite.txt )

#
# Configure the files
#
configure_file(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/MITKFiles.txt.in
  ${KWSTYLE_MITK_FILES_LIST})

configure_file(
  ${PROJECT_SOURCE_DIR}/Utilities/KWStyle/MITK.kws.xml.in
...
set(KWSTYLE_ARGUMENTS_CODE
  -xml ${KWSTYLE_CONFIGURATION_FILE} -v -D ${KWSTYLE_MITK_FILES_LIST}
  -o ${KWSTYLE_MITK_OVERWRITE_FILE} ${KWSTYLE_EDITOR_FORMAT}
  )

add_custom_command(
  OUTPUT  ${MITK_BINARY_DIR}/KWStyleCodeReport.txt
  COMMAND ${KWSTYLE_EXECUTABLE}
  ARGS    ${KWSTYLE_ARGUMENTS_CODE}
  COMMENT "Coding Style Checker"
  )

add_custom_target(StyleCheckCode DEPENDS ${MITK_BINARY_DIR}/KWStyleCodeReport.txt)

add_test(KWStyleCodeTest   ${KWSTYLE_EXECUTABLE} ${KWSTYLE_ARGUMENTS_CODE})

endif(KWSTYLE_FOUND)
endif(KWSTYLE_EXECUTABLE)
endif(MITK_USE_KWSTYLE)
